...
class Proveedor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombreCorto', 'length', 'max'=>15),
			array('contacto, correo', 'length', 'max'=>100),
			array('tel', 'length', 'max'=>40),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('folio, nombre, nombreCorto, contacto, correo, tel', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'articulos' => array(self::HAS_MANY, 'Articulo', 'id_proveedor'),
		);
	}
